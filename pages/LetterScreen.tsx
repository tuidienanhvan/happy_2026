...
const LetterScreen: React.FC<Props> = ({ onForgive }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="relative w-full max-w-[1000px] aspect-[4/5] md:aspect-[3/2]">

                {/* === APOLOGY LETTER CARD === */}
                <div className="absolute inset-0 bg-[#fffbf0] shadow-[0_20px_50px_rgba(0,0,0,0.6)] flex flex-col animate-[tilt-in_1s_ease-out]">
