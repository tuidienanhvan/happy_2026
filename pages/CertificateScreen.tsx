    ...
    <div className="w-full h-full bg-[#fffbf0] shadow-[0_30px_60px_rgba(0,0,0,0.7)] flex flex-col relative">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-between p-4 md:p-8 text-center">
        ...
        <div
          ...
          className="absolute bottom-24 right-8 md:bottom-28 md:right-12 transform mix-blend-multiply z-40 cursor-pointer hover:scale-110 active:scale-95 transition-transform duration-200 animate-[stamp-bounce_0.5s_ease-out_0.3s_forwards] opacity-0"
        >
