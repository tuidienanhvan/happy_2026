...
import { Heart, Star, Gift, CheckCircle2, Sparkles, PartyPopper } from 'lucide-react';
...
const CertificateScreen: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative overflow-visible z-50 p-4">
      ...
      <div className="relative group w-full max-w-[1000px] aspect-[4/5] md:aspect-[4/3] bg-[#fffbf0] shadow-[0_30px_60px_rgba(0,0,0,0.7)] flex flex-col animate-[tilt-in_1s_ease-out]">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-between p-4 md:p-8 text-center">
          ...
          <div
            ...
            className="absolute bottom-28 right-12 md:bottom-32 md:right-16 transform mix-blend-multiply z-40 cursor-pointer hover:scale-110 active:scale-95 transition-transform duration-200 animate-[stamp-bounce_0.5s_ease-out_1s_forwards] opacity-0"
          >
      ...
      {/* Firework Button */}
      <div className="mt-6 z-50 transform w-full flex justify-center">
